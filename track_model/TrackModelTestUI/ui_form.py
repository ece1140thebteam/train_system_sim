...
class Ui_TrackModelTestUI(object):
    ...
    def retranslateUi(self, TrackModelTestUI):
        ...
        self.updateTypeDropdown.setItemText(1, QCoreApplication.translate("TrackModelTestUI", u"Rail Crossing", None))
        self.updateTypeDropdown.setItemText(2, QCoreApplication.translate("TrackModelTestUI", u"Switch Position", None))
        self.updateTypeDropdown.setItemText(3, QCoreApplication.translate("TrackModelTestUI", u"Maintenance", None))
        self.updateTypeDropdown.setItemText(4, QCoreApplication.translate("TrackModelTestUI", u"Authority", None))
        self.updateTypeDropdown.setItemText(5, QCoreApplication.translate("TrackModelTestUI", u"Failure", None))
        self.updateTypeDropdown.setItemText(6, QCoreApplication.translate("TrackModelTestUI", u"Commanded Speed", None))
        self.updateTypeDropdown.setItemText(7, QCoreApplication.translate("TrackModelTestUI", u"Signal", None))
